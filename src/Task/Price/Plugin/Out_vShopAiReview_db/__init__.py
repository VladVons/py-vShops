...
Не вживай хвалебних слів типу цих та інших: відмінний, ідеальний, чудовий, незамінимий, для професіоналів, високоякісний, неперевершений.
''',
...
async def UpdateDb(aSql: TSqlBase, aSqlConf: TSqlTenantConf) -> list[int]:
    ...
    Dbl = await aSql.ExecQuery(__package__, 'fmtGet_Review.sql',
        {
...
class TOut_vShopAiReview_db(TPluginBase):
    async def Run(self):
